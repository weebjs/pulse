...
class Client extends node_events_1.EventEmitter {
    ...
    constructor(options) {
         ...
         */
        this.ws = new api_1.WebSocketManager(Object.assign(Object.assign({}, this.options.ws), { token: this.options.token }));
        /**
    ...
    login(opts) {
        if (opts === null || opts === void 0 ? void 0 : opts.fresh)
            this.ws = new api_1.WebSocketManager({
    ...
    fetchServers() {
        var _a;
        return this.users.fetchServers((_a = this.user) === null || _a === void 0 ? void 0 : _a.id);
    }
    /**
