...
class GlobalChannelManager extends CacheableStructManager_1.CacheableStructManager {
    ...
    delete(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.rest.router.channels.channelDelete({
                channelId,
            });
    ...
    archive(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.rest.router.channels.channelArchiveCreate({
                channelId,
            });
            const existingChannel = this.cache.get(channelId);
    ...
    unarchive(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.rest.router.channels.channelArchiveDelete({
                channelId,
            });
            const existingChannel = this.cache.get(channelId);
            return existingChannel !== null && existingChannel !== void 0 ? existingChannel : null;
