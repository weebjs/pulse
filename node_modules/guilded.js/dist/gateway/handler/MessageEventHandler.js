...
class MessageEventHandler extends GatewayEventHandler_1.GatewayEventHandler {
    messageCreated(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_b = (_a = this.client.options.cache) === null || _a === void 0 ? void 0 : _a.fetchMessageAuthorOnCreate) !== null && _b !== void 0 ? _b : true) &&
                data.d.serverId &&
                data.d.message.createdBy &&
                data.d.message.createdBy !== "Ann6LewA")
                yield this.client.members
    ...
    messageDeleted(data) {
        ...
        return this.client.emit(constants_1.constants.clientEvents.MESSAGE_DELETED, Object.assign({}, data.d.message));
    }
}
