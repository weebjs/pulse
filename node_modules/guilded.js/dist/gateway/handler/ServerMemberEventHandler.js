...
class ServerMemberEventHandler extends GatewayEventHandler_1.GatewayEventHandler {
    serverMemberUpdated(data) {
        ...
        member === null || member === void 0 ? void 0 : member._update({
            nickname: (_a = data.d.userInfo.nickname) !== null && _a !== void 0 ? _a : undefined,
        });
    ...
    serverMemberJoined(data) {
        ...
        if (data.d.member.user.id === ((_a = this.client.user) === null || _a === void 0 ? void 0 : _a.id))
