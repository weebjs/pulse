...
class GuildedRouter {
    constructor(rest) {
        this.request =
            new FetchHttpRequest_1.FetchHttpRequest(rest);
        this.announcementComments =
            new AnnouncementCommentsService_1.AnnouncementCommentsService(this
                .request);
        this.announcements =
            new AnnouncementsService_1.AnnouncementsService(this
                .request);
        this.calendarEventComments =
            new CalendarEventCommentsService_1.CalendarEventCommentsService(this
                .request);
        this.calendarEvents =
            new CalendarEventsService_1.CalendarEventsService(this
                .request);
        this.calendarEventSeries =
            new CalendarEventSeriesService_1.CalendarEventSeriesService(this
                .request);
        this.categories =
            new CategoriesService_1.CategoriesService(this
                .request);
        this.channels =
            new ChannelsService_1.ChannelsService(this
                .request);
        this.chat =
            new ChatService_1.ChatService(this
                .request);
        this.docComments =
            new DocCommentsService_1.DocCommentsService(this
                .request);
        this.docs =
            new DocsService_1.DocsService(this
                .request);
        this.forumComments =
            new ForumCommentsService_1.ForumCommentsService(this
                .request);
        this.forums =
            new ForumsService_1.ForumsService(this
                .request);
        this.groupMembership =
            new GroupMembershipService_1.GroupMembershipService(this
                .request);
        this.groups =
            new GroupsService_1.GroupsService(this
                .request);
        this.listItems =
            new ListItemsService_1.ListItemsService(this
                .request);
        this.memberBans =
            new MemberBansService_1.MemberBansService(this
                .request);
        this.members =
            new MembersService_1.MembersService(this
                .request);
        this.reactions =
            new ReactionsService_1.ReactionsService(this
                .request);
        this.roleMembership =
            new RoleMembershipService_1.RoleMembershipService(this
                .request);
        this.roles =
            new RolesService_1.RolesService(this
                .request);
        this.servers =
            new ServersService_1.ServersService(this
                .request);
        this.serverXp =
            new ServerXpService_1.ServerXpService(this
                .request);
        this.socialLinks =
            new SocialLinksService_1.SocialLinksService(this
                .request);
        this.users =
            new UsersService_1.UsersService(this
                .request);
        this.userStatus =
            new UserStatusService_1.UserStatusService(this
                .request);
        this.webhook =
            new WebhookService_1.WebhookService(this
                .request);
        this.serverSubscriptions =
            new ServerSubscriptionService_1.ServerSubscriptionService(this
                .request);
    }
}
