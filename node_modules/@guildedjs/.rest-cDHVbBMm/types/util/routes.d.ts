...
export declare const ROUTES: {
    ...
    readonly memberSocialLinks: (serverId: string, userId: string, type: UserSocialLink) => `/servers/${string}/members/${string}/social-links/bnet` | `/servers/${string}/members/${string}/social-links/facebook` | `/servers/${string}/members/${string}/social-links/origin` | `/servers/${string}/members/${string}/social-links/patreon` | `/servers/${string}/members/${string}/social-links/psn` | `/servers/${string}/members/${string}/social-links/roblox` | `/servers/${string}/members/${string}/social-links/steam` | `/servers/${string}/members/${string}/social-links/switch` | `/servers/${string}/members/${string}/social-links/twitch` | `/servers/${string}/members/${string}/social-links/twitter` | `/servers/${string}/members/${string}/social-links/xbox` | `/servers/${string}/members/${string}/social-links/youtube`;
